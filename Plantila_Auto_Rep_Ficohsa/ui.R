...
shinyUI(fluidPage(
  ...
  dashboardPage(
    ...
    dashboardHeader(title="Grupo Financiero Ficohsa", titleWidth = 300),
    
    dashboardSidebar(width = 300,
      sidebarMenu(
        HTML(paste0(
          "<br>",
          "<a href='https://www.nps.gov/index.htm' target='_blank'><img style = 'display: block; margin-left: auto; margin-right: auto;' src='logo_ficohsa1.webp' width = '186'></a>",
          "<br>",
          "<p style = 'text-align: center;'><small><a href='https://www.ficohsa.com/hn' target='_blank'>Queremos que llegues lejos</a></small></p>",
          "<br>"
        )),
        ...
        HTML(paste0(
          ...
          "</script>",
          "<p style = 'text-align: center;'><small>&copy; - <a href='https://j-isaula.github.io/website_ji/' target='_blank'>JuanIsaula.com</a> - <script>document.write(yyyy);</script></small></p>")
        ))
      )
